...
namespace XRSharpSamplesGallery.Menu
{
    internal class MenuItems : List<MenuItem>
    {
        public MenuItems()
        {
            ...
            {
                Title = "Game",
                PageToNavigateTo = typeof(Game),
                ThumbnailUri = "/Menu/Thumbnails/Game.png",
                ViewSourceFilesLocation = new[]
                {
                    new ViewSourceFileInfo() { TabHeader = "Game.xaml", FilePathOnGitHub = "github/XRSharp/XRSharpSamplesGallery/blob/main/src/XRSharpSamplesGallery/XRSharpSamplesGallery/Samples/Calculator3D/Calculator3D.xaml" },
                    new ViewSourceFileInfo() { TabHeader = "Game.xaml.cs", FilePathOnGitHub = "github/XRSharp/XRSharpSamplesGallery/blob/main/src/XRSharpSamplesGallery/XRSharpSamplesGallery/Samples/Calculator3D/Calculator3D.xaml.cs" }
                }
            });
            //this.Add(new()
            //{
